...
.method static synthetic access$200(Landroid/content/Context;)V
    ...
    .prologue
    .line 79
    invoke-static {p0}, Lcom/android/server/power/ShutdownThread;->triggerReboot(Landroid/content/Context;)V
...
.method public static rebootAdvanced(Landroid/content/Context;ZZ)V
    .locals 1
    .param p0, "context"    # Landroid/content/Context;
    .param p1, "confirm"    # Z
    .param p2, "advanced"    # Z
    ...
    .line 350
    :cond_0
    invoke-static {p0}, Lcom/android/server/power/ShutdownThread;->showAdvancedReboot(Landroid/content/Context;)V
...
.method static showAdvancedReboot(Landroid/content/Context;)V
    .locals 8
    .param p0, "context"    # Landroid/content/Context;
    ...
    const-string v6, "advanced_reboot_oneclick"
    ...
    invoke-direct {v4, v2, p0}, Lcom/android/server/power/ShutdownThread$2;-><init>([Ljava/lang/String;Landroid/content/Context;)V

    invoke-virtual {v0, v7, v4}, Landroid/app/AlertDialog$Builder;->setItems(ILandroid/content/DialogInterface$OnClickListener;)Landroid/app/AlertDialog$Builder;
    ...
    .restart local v3    # "instantTrigger":Z
    :cond_2
    new-instance v5, Lcom/android/server/power/ShutdownThread$3;

    invoke-direct {v5, v2}, Lcom/android/server/power/ShutdownThread$3;-><init>([Ljava/lang/String;)V

    invoke-virtual {v0, v7, v4, v5}, Landroid/app/AlertDialog$Builder;->setSingleChoiceItems(IILandroid/content/DialogInterface$OnClickListener;)Landroid/app/AlertDialog$Builder;
...
.method private static triggerReboot(Landroid/content/Context;)V
    .locals 4
    .param p0, "context"    # Landroid/content/Context;
    ...
    invoke-static {p0, v2, v3}, Lcom/android/server/power/ShutdownThread;->reboot(Landroid/content/Context;Ljava/lang/String;Z)V
