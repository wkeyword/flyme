...
.method private installProviderAuthoritiesLocked(Landroid/content/IContentProvider;Landroid/content/ContentProvider;Landroid/app/IActivityManager$ContentProviderHolder;)Landroid/app/ActivityThread$ProviderClientRecord;
    ...
    .prologue
    .line 4965
    iget-object v9, p3, Landroid/app/IActivityManager$ContentProviderHolder;->info:Landroid/content/pm/ProviderInfo;
    ...
    .line 4968
    .local v8, "userId":I
    new-instance v7, Landroid/app/ActivityThread$ProviderClientRecord;

    invoke-direct {v7, v2, p1, p2, p3}, Landroid/app/ActivityThread$ProviderClientRecord;-><init>([Ljava/lang/String;Landroid/content/IContentProvider;Landroid/content/ContentProvider;Landroid/app/IActivityManager$ContentProviderHolder;)V

    .line 4970
    .local v7, "pcr":Landroid/app/ActivityThread$ProviderClientRecord;
    move-object v0, v2
    ...
    invoke-direct {v5, v1, v8}, Landroid/app/ActivityThread$ProviderKey;-><init>(Ljava/lang/String;I)V
    ...
    .line 4973
    .local v3, "existing":Landroid/app/ActivityThread$ProviderClientRecord;
    if-eqz v3, :cond_0
    ...
    iget-object v11, v7, Landroid/app/ActivityThread$ProviderClientRecord;->mHolder:Landroid/app/IActivityManager$ContentProviderHolder;

    iget-object v11, v11, Landroid/app/IActivityManager$ContentProviderHolder;->info:Landroid/content/pm/ProviderInfo;
    ...
    const-string v11, " already published as "
    ...
    .end local v3    # "existing":Landroid/app/ActivityThread$ProviderClientRecord;
...
# virtual methods
.method final acquireExistingProvider(Landroid/content/Context;Landroid/app/ActivityThread$ProviderKey;Z)Landroid/content/IContentProvider;
    .locals 9
...
.method public final acquireProvider(Landroid/content/Context;Ljava/lang/String;IZ)Landroid/content/IContentProvider;
    ...
    .line 4648
    :try_start_2
    iput-object v2, v10, Landroid/app/ActivityThread$AcquiringProviderRecord;->holder:Landroid/app/IActivityManager$ContentProviderHolder;
    ...
    :cond_4
    :try_start_8
    iget-object v2, v10, Landroid/app/ActivityThread$AcquiringProviderRecord;->holder:Landroid/app/IActivityManager$ContentProviderHolder;
